...
# AUR ve resmi depolardan paket kurulumu
install_packages() {
    local pkgs=(
        7zip
        adw-gtk-theme
...
# Yerel .pkg.tar.zst dosyalarını kurma
...
set_default_themes() {
    ...
    info "Tema ayarları yapılıyor..."

    # GTK ayarları
    info "GTK temaları ayarlanıyor..."
...
EOF
    ...
    success "GTK temaları ayarlandı."

    # X11 imleç teması
    info "X11 imleç teması ayarlanıyor..."
...
EOF
    ...
    # .profile ayarları
    info "Ortam değişkenleri ayarlanıyor..."
...
# Gerekli servisleri etkinleştirme
enable_services() {
